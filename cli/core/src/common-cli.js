...
import { AbstractCLI, getProjectName } from './abstract-cli';
...
export class CommonCLI extends AbstractCLI {
    constructor(name, version) {
        ...
        this.addCommand('serve', 'Developing (https://webpack.js.org/)', serveOptions
            .concat([
        ...
        this.addCommand('build', 'Building (https://webpack.js.org/)', buildOptions.concat(commonOptions), (options) => {
        ...
        this.addCommand('e2e', 'E2E-Testing (https://nightwatchjs.org/)', [
        ...
        this.addCommand('format', 'Formatter (https://prettier.io/)', [{ flags: '-f, --fix', description: 'fix the code format' }].concat(commonOptions), (options) => {
        ...
        this.addCommand('lint', 'Linter (ESLint: https://eslint.org/)', [{ flags: '-f, --fix', description: 'fix the lint findings' }].concat(commonOptions), (options) => {
            const spawnArgs = ['eslint'];
            if (options.fix) {
                spawnArgs.push('--fix');
            }
            spawnArgs.push(`"{src,tests}/**/*.{html,js,json,jsx,ts,tsx,gql,graphql}"`);
            return spawnArgs;
        });
        this.addCommand('test', 'Unit-Testing (https://mochajs.org/)', [{ flags: '-w, --watch', description: 'run tests in watch mode' }].concat(commonOptions), (options) => {
        ...
        this.addCommand('coverage', 'Unit-Test-Coverage (https://istanbul.js.org/)', [{ flags: '-w, --watch', description: 'run tests in watch mode' }].concat(commonOptions), (options) => {
