...
> This package contains the [Aurelia](https://aurelia.io) CLI adapter. You can create a new or switch a existing project to the [@leanup/stack](https://www.npmjs.com/package/@leanup/stack).
