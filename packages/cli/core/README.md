...
|                            autoprefixer |                                                                                          [![install size of chai](https://packagephobia.now.sh/badge?p=autoprefixer)](https://packagephobia.now.sh/result?p=autoprefixer) | [![vulnerabilities of autoprefixer](https://img.shields.io/snyk/vulnerabilities/npm/autoprefixer)](https://snyk.io/test/npm/autoprefixer)                                                                                  |
